...
data_out[22] <= data_in[34];
data_out[23] <= data_in[35];
...
data_out[4] <= data_in[23];
data_out[5] <= data_in[31];
data_out[6] <= data_in[8];
data_out[7] <= data_in[11];
data_out[8] <= data_in[18];
data_out[9] <= data_in[19];
...
data_out[16] <= data_in[29];
data_out[17] <= data_in[33];
data_out[18] <= data_in[3];
data_out[19] <= data_in[10];
data_out[20] <= data_in[16];
data_out[21] <= data_in[17];
...
data_out[33] <= data_in[16];
data_out[34] <= data_in[20];
data_out[35] <= data_in[32];
end
...
data_out[5] <= data_in[24];
data_out[6] <= data_in[7];
data_out[7] <= data_in[13];
data_out[8] <= data_in[25];
data_out[9] <= data_in[30];
...
data_out[31] <= data_in[18];
data_out[32] <= data_in[20];
data_out[33] <= data_in[23];
data_out[34] <= data_in[29];
data_out[35] <= data_in[35];
end
